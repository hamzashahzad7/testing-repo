    ...
    return (
        <div className="relative w-full flex justify-center items-start -mt-[7%] pointer-events-none">
            ...
            <img
                ...
                alt="iPhone Mockup"
                className="relative w-[90%] h-fit object-contain z-10 mt-15 lg:hidden"
            />

            {/* Floating Containers */}
            {/* Left container */}
            <div className="absolute left-[8%] lg:left-[23%] top-[25%] lg:top-[20%] bg-black/20 lg:backdrop-blur-lg rounded-full px-2 lg:px-4 py-1.5 lg:py-3 flex items-center gap-3 lg:gap-6 z-20 text-[10px] lg:text-[18px]">
                ...
                <img src="/assets/icons/Planet.png" alt="Apollo" className="w-7 h-7 lg:w-10 lg:h-10" />
            </div>
